...
export default function Home() {
  ...
  return (
    <div className="w-full">
      <Header />
      <div className={classNames("p-8 relative w-full  h-[calc(100vh_-_98px)]")}>
        <div
          className={classNames(
            "w-full h-full flex flex-col justify-center gap-y-20",
            styles.bgImag
          )}
        >
          <div className="flex w-full justify-center items-center flex-col absolute bottom-[72px]">
            <div className="flex flex-col justify-start items-start gap-y-[200px]">
              <div className="flex flex-col items-center gap-y-3">
                ...
                <div className="h-[64px] bg-[#FFFFFF] rounded-[46px] px-8 flex items-center gap-x-7">
                  <SearchIcon />
