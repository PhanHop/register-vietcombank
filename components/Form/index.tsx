...
export default function Form({ activeIndex, children }: Props) {
  return (
    <div className="grid grid-cols-7 grid-flow-col w-full h-[100vh]">
      <div className="flex flex-col col-span-2 w-full h-full bg-[#F4F4F4] px-[50px] lg:gap-y-10 2xl:gap-y-20 lg:pt-5 xl:pt-8 2xl:pt-14">
      ...
      >
        <div className="lg:px-[94px] xl:px-[114px] 2xl:px-[144px] w-full">{children}</div>
        <div className="absolute bottom-0 left-0 right-0 w-full bg-white z-10 px-[60px] py-[18px] border-t-[2px] border-solid border-[#EAEAEA] grid grid-cols-3">
          {Footer?.map((item) => {
            return (
