      ...
      <div className="px-8 flex justify-between">
        <div className="flex items-center gap-x-8">
          <div className="flex gap-x-6 items-center">
            <div className="h-11 w-11 rounded-[36px] bg-[#EAEAEA] flex items-center justify-center">
              <ListMenuIcon />
            </div>
        ...
        <div className="flex gap-x-8 items-center">
          ...
          <div className="bg-[#FFEEED] w-8 h-8 rounded-[52px] flex items-center justify-center">
            <LogOutIcon />
          </div>
        </div>
      </div>
